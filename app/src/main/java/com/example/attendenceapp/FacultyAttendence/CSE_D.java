...
//
//public class CSE_D extends AppCompatActivity {
//
...
//                            Toast.makeText(CSE_D.this, "Student ID " + id + " is already registered", Toast.LENGTH_SHORT).show();
//                        } else {
...
//                    } else {
//                        // Handle error
//                        Toast.makeText(CSE_D.this, "Error checking student: " + task.getException(), Toast.LENGTH_SHORT).show();
//                    }
//                });
//    }
//
...
//
//                    Toast.makeText(CSE_D.this, "Student added successfully", Toast.LENGTH_SHORT).show();
//                    dialog.dismiss();  // Close the dialog
//                })
//                .addOnFailureListener(e -> {
//                    // Handle failure
//                    Toast.makeText(CSE_D.this, "Failed to add student: " + e.getMessage(), Toast.LENGTH_SHORT).show();
//                });
//    }
//
...
//                    } else {
//                        // Handle error
//                        Toast.makeText(CSE_D.this, "Failed to fetch students: " + task.getException(), Toast.LENGTH_SHORT).show();
//                    }
//                });
//    }
//
